 ...
 * POJO for Blog Posts
 */
public class BBNPost extends DBEntry {

    public BBNPost(String data, String language, DateTime dateTime, String source, String url, String guid, String filename, boolean optimized) {
        super(filename);
        setData(data);
    ...
    public BBNPost(String data, String language, DateTime dateTime, String source, String url, String guid, String filename) {
        super(filename);
        setData(data);
        setLanguage(language);
        setDateTime(dateTime);
    ...
    public BBNPost(BasicDBObject cur) {
        super(cur);
    }
