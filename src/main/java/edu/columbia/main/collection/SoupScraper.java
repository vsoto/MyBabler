        ...
        for (SyndEntry item : entries){
            ...
            try {
                    ...
                    if (result.languageCode.equals(language) && result.isReliable) {
                        ...
                        FileSaver file = new FileSaver(content, this.language, "soup", item.getLink(), item.getUri(), String.valueOf(content.hashCode()));
                        String fileName = file.getFileName();
                        Post post = new Post(content, this.language, null, "soup", item.getLink(), item.getUri(), fileName);
