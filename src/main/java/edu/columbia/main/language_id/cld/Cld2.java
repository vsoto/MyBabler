...
public class Cld2 extends LanguageClassifier {
    ...
    public static edu.columbia.main.language_id.Result detect(String text) throws IOException, ClassNotFoundException {
        ...
        try {
            ...
            return new edu.columbia.main.language_id.Result(null, false, 0, "cld2");
        ...
        return new edu.columbia.main.language_id.Result(lc.getLanguageCode(), isReliable[0], percent3[0] / 100.0, "cld2");
